# Overview
Inspired by [this](https://github.com/LemonFaceSour/BandLogos) repo I've built a script which downloads logos from fanart.tv for the artists in your Plex library, makes the pictures square, and sets them as the artist picture in Plex.
